...
Set up the computational environment (Section 4)
Configure and run simulations (Section 5)
Generate plots from cached or newly computed results
...
Runtime notes
Simulation sweeps may take tens of hours (under 
50
